...
function FormUpdateUser(props) {
    const [userInfoData, setUserInfoData] = useState({
      id: props.userInfoToUpdate.id,
      name: props.userInfoToUpdate.name,
      surName: props.userInfoToUpdate.surName,
      phoneNumber: props.userInfoToUpdate.phoneNumber,
      email: props.userInfoToUpdate.email
